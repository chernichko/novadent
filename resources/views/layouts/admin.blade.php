        ...
        <main class="py-4">
            <div class="leftMenu float-left w-25">
                <ul class="list-group">
                    ...
                    <li class="list-group-item"><a href="{{route('admin.gallery')}}">Галлерея</a></li>
                    <li class="list-group-item"><a href="{{route('admin.gallery')}}">Лицензии</a></li>
                    <li class="list-group-item"><a href="{{route('admin.feedback')}}">Отзывы</a></li>
                </ul>
            </div>
                @yield('content')
        </main>
