...
@section('title')
    <li class="breadcrumb-item"><a href="{{route('admin.article')}}">Статьи</a></li>
...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="/admin/article/edit/{{$new->id}}" method="post" enctype="multipart/form-data" class="news_form">
                {{csrf_field()}}
                ...
                <div class="form-group">
                    ...
                    @if($new->image)
                        <img src="/storage/files/article/{{$new->image}}" class="w-25 d-block pb-3">
