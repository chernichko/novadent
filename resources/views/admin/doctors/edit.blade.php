...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            ...
            <form action="/admin/doctors/edit/{{$doctor->id}}" method="post" enctype="multipart/form-data" class="doctors_form">
                {{csrf_field()}}
                ...
                <div class="row">
                    ...
                    <div class="col-9">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" value="{{$doctor->name}}" name="name" id="nameDoctor">
                        </div>
                        <div class="form-group">
                            <label for="specializationDoctor">Специализация</label>
                            <input type="text" class="form-control" value="{{$doctor->specialization}}" name="specialization" id="specializationDoctor">
                        </div>
                        <div class="form-group">
                            <label for="stageDoctor">Стаж</label>
                            <input type="text" class="form-control" value="{{$doctor->stage}}" name="stage" id="stageDoctor">
                        </div>
                    </div>
                </div>
                <div class="form-group">
                    <label for="descriptionDoctor">Описание</label>
                    <textarea class="form-control" id="descriptionDoctor" value="{{$doctor->description}}" name="description" rows="8"></textarea>
                </div>

                <div class="form-group form-check">
                    <input type="checkbox" value="1" name="active" class="form-check-input" id="doctorActive" @php print($doctor->active ? 'checked' : '') @endphp>
